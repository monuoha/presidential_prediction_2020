...
author: "Michael Onuoha, Travis Barton"
date: "10/6/2020"
...
data <- read_csv('polls/president_polls.csv')
attach(data)  # eliminates the need for data$....
```

### Where is our data from?
#The data is from the FiveThirtyEight website

### Why did we choose it?
#The variables that we chose are relatively more vital to accurately determining who will win the upcoming election
...
#### find how many rows are in each grade?
...
#### delete rows that that start past some cutoff?
# end_dates end too soon. 
#### delete rows that end too soon?
...
#### delete rows that have too short/long a duration
...
#### plot the density of sample sizes
